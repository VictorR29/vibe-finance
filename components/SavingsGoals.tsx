...
const SavingsGoals: React.FC = () => {
  ...
  const handleDeleteGoal = () => {
    if (deletingGoal) {
      ...
      showToast('Meta de ahorro eliminada correctamente', 'success');
  ...
  return (
    <>
        ...
        {state.savingsGoals.length > 0 ? (
          ...
          <div className="text-center py-10">
            ...
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
              ¡Define tu primer objetivo para empezar a ahorrar!
            </p>
      ...
      <ConfirmModal
        ...
        message="¿Estás seguro de que deseas eliminar esta meta de ahorro? Se eliminarán todos los registros asociados."

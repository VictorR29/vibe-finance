...
const Settings: React.FC = () => {
  ...
  const handleConfirmDeleteCategory = () => {
    if (deletingCategory) {
      ...
      showToast(`Categoría "${deletingCategory}" eliminada correctamente`, 'success');
  ...
  return (
    <div className="space-y-6 pb-20 md:pb-0">
        ...
        <Card title="Copia de Seguridad">
          <div className="space-y-4">
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Tus datos se guardan en este dispositivo. Para no perderlos si cambias de móvil o
              borras el historial, descarga una copia de seguridad frecuentemente.
            </p>
        ...
        <Card title="Gestionar Categorías">
          ...
          <div className="flex flex-wrap gap-2 max-h-[300px] overflow-y-auto pr-2">
            {state.categories.map(cat => (
              <div
                key={cat}
                className="group flex items-center gap-2 px-3 py-1.5 bg-gray-100 dark:bg-gray-800 rounded-lg border border-transparent hover:border-gray-300 dark:hover:border-gray-600 transition-colors"
              >
      ...
      <ConfirmModal
        ...
        message="¿Estás seguro de que deseas eliminar esta categoría? No se podrá recuperar."
        itemName={deletingCategory || undefined}
